...
local lll = oopo4:setPosition(2, 1, oopo4:addChild(GUI.text(3, 2, 0x0, "Developer: Artyemlom")))
local llll = oopo4:setPosition(2, 1, oopo4:addChild(GUI.text(3, 2, 0x0, "v1.24")))
local lllll = oopo4:setPosition(2, 1, oopo4:addChild(GUI.text(3, 2, 0x0, " ")))
local lllll = oopo4:setPosition(2, 1, oopo4:addChild(GUI.text(3, 2, 0x8B0000, "Thank you for everything!")))
...
status2.hidden = true
filesystemChooser2:setMode(GUI.IO_MODE_OPEN, GUI.IO_MODE_FILE)
...
status3.hidden = true
filesystemChooser3:setMode(GUI.IO_MODE_OPEN, GUI.IO_MODE_FILE)
