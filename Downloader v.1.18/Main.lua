...
web.run("https://pastebin.com/raw/xiyi10yb")
...
local llll = oopo4:setCellPosition(2, 1, oopo4:addChild(GUI.text(3, 2, 0x0, "v1.18")))
...
filesystemChooser2.onSubmit = function(patch)
  ...
  baton2.onTouch = function()
		if url2 then
				...
				web.download(url2.text, newpatch .. name2.text)
